...
<head>
    ...
    <link rel="icon" href="resources/static/favicon.ico" type="image/x-icon"> <!-- Favicon-->

    <!-- plugin css file  -->
    <link rel="stylesheet" href="resources/static/assets/plugin/datatables/responsive.dataTables.min.css">
    <link rel="stylesheet" href="resources/static/assets/plugin/datatables/dataTables.bootstrap5.min.css">

    <!-- project css file  -->
    <link rel="stylesheet" href="resources/static/assets/css/ebazar.style.min.css">
</head>
<body>
                        ...
                        <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                            ...
                            <div class="dropdown zindex-popover">
                                <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
                                    <img src="resources/static/assets/images/flag/GB.png" alt="">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                                    <div class="card border-0">
                                        <ul class="list-unstyled py-2 px-3">
                                            <li>
                                                <a href="#" class=""><img src="resources/static/assets/images/flag/GB.png" alt=""> English</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="resources/static/assets/images/flag/DE.png" alt=""> German</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="resources/static/assets/images/flag/FR.png" alt=""> French</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="resources/static/assets/images/flag/IT.png" alt=""> Italian</a>
                                            </li>
                                            <li>
                                                <a href="#" class=""><img src="resources/static/assets/images/flag/RU.png" alt=""> Russian</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <ul class="list-unstyled list mb-0">
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="resources/static/assets/images/xs/avatar1.svg" alt="">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="resources/static/assets/images/xs/avatar3.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="resources/static/assets/images/xs/avatar5.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="resources/static/assets/images/xs/avatar6.svg" alt="">
                                                            <div class="flex-fill ms-2">
                                                    ...
                                                    <li class="py-2">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            <img class="avatar rounded-circle" src="resources/static/assets/images/xs/avatar7.svg" alt="">
                                                            <div class="flex-fill ms-2">
                            ...
                            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                ...
                                <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                    <img class="avatar lg rounded-circle img-thumbnail" src="resources/static/assets/images/profile_av.svg" alt="profile">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                    <div class="card border-0 w280">
                                        <div class="card-body pb-0">
                                            <div class="d-flex py-1">
                                                <img class="avatar rounded-circle" src="resources/static/assets/images/profile_av.svg" alt="profile">
                                    ...
                                    <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">  
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="resources/static/assets/images/product/product-1.jpg" class="avatar lg rounded me-2" alt="profile-image"><span> Oculus VR </span></td>
                                                <td>Molly</td>
                                                <td>Credit Card</td>
                                                <td>
                                                    $420
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="resources/static/assets/images/product/product-2.jpg" class="avatar lg rounded me-2" alt="profile-image"><span>Wall Clock</span></td>
                                                <td>Brian</td>
                                                <td>Debit Card</td>
                                                <td>
                                                    $220
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="resources/static/assets/images/product/product-3.jpg" class="avatar lg rounded me-2" alt="profile-image"><span>Note Diaries</span></td>
                                                <td>Julia</td>
                                                <td>Debit Card</td>
                                                <td>
                                                    $250
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="resources/static/assets/images/product/product-4.jpg" class="avatar lg rounded me-2" alt="profile-image"><span>Flower Port</span></td>
                                                <td>Sonia</td>
                                                <td>Credit Card</td>
                                                <td>
                                                    $320
    ...
    <!-- Jquery Core Js -->
    <script src="resources/static/assets/bundles/libscripts.bundle.js"></script>

    <!-- Plugin Js -->
    <script src="resources/static/assets/bundles/apexcharts.bundle.js"></script>
    <script src="resources/static/assets/bundles/dataTables.bundle.js"></script>  
